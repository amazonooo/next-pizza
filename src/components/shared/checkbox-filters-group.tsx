...
export const CheckboxFiltersGroup: FC<ICheckboxFiltersGroup> = ({ className, items, title, defaultItems, defaultValue, limit = 5, onChange, searchInputPlaceholder = 'Поиск...' }) => {
